...
export class AppComponent {
    quotes = [
        ...
        new Quote(3, 'Get new Phone Case','Diana has her birthday coming soon',new Date(2018,1,12) ),
        new Quote(4, 'Get Dog Food','Pupper like expensive snacks',new Date(2018,0,18) ),
